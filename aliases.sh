...
alias ktns="kubectl top nodes"
alias ktps="kubectl top pods"
...
# Function to get all pods in current namespace with the nodes that they reside in
nopo () {
  kubectl get pod -o=custom-columns=NAME:.metadata.name,STATUS:.status.phase,NODE:.spec.nodeName
}

# Function to get all pods in all namespaces along with the nodes that they reside in
nopoall () {
  kubectl get pod -o=custom-columns=NAME:.metadata.name,STATUS:.status.phase,NODE:.spec.nodeName --all-namespaces
}

# Functional replacement for "kubectl get pods | grep <PODNAME>" and changing it to "kgrep <PODNAME>"
kgrep () {
  kubectl get pods | grep $1
}

# Functional replacement for "kubectl logs <PODNAME> -c service | grep <SOMETHING> | wc -l" and changing it to "kgrepcount <PODNAME> <SOMETHING>"
kgrepcount (){
  kubectl logs $1 -c service | grep "$2" | wc -l
}

# Functional replacement for "kubectl logs <PODNAME> -c service" and changing it to "klserv <PODNAME>"
klserv (){
  kubectl logs $1 -c service
}
...
findpod (){
  ...
  for namespace in "${all_namespaces[@]}"; do 
    kubens $namespace
    echo "=======================================================$(kubens -c)=============================================================="
    kubectl get pods | grep $string_to_search    
  done
}
